...
// Get the elements to calculate the price and total price
  const qtyInput = document.getElementById('qty');
  const priceOutput = document.getElementById('price');
  const totalpriceOutput = document.getElementById('Totalprice');


  function totalPriceQty() {
    const total = qtyInput.value * 13.99;
    
    priceOutput.innerHTML = total;
    totalpriceOutput.innerHTML = total;

  }


  // Get the elements to calculate the price and total price for complete edition
  const compQtyInput = document.getElementById('comp-qty');
  const compPriceOutput = document.getElementById('comp-price');
  const compTotalpriceOutput = document.getElementById('comp-total-price');

  function ComptotalPriceQty() {
    const total = compQtyInput.value * 19.99;
    
    compPriceOutput.innerHTML = total;
    compTotalpriceOutput.innerHTML = total;
